...
namespace Dan.Demo
{
    public class LeaderboardShowcase : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.TakeABreath.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        public void Submit()
        {
            Leaderboards.TakeABreath.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }
        
        public void DeleteEntry()
        {
            Leaderboards.TakeABreath.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.TakeABreath.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
